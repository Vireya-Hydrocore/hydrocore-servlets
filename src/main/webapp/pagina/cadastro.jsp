...
<head>
    ...
    <link rel="shortcut icon" href="${pageContext.request.contextPath}imgs/vireya%20icon.png" type="image/x-icon">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/pagina/css/cadastro.css">
...
<main>
    <div id="formSlide">
        <div class="container-esquerdo">
            <div class="logo">
                <img src="${pageContext.request.contextPath}/pagina/imgs/vireya%20icon.png">
                <span>HydroCore</span>
            </div>
            <h1>Criar Conta</h1>
            ...
            <form action="cadastro2.jsp" method="post" id="form">
                ...
                <p class="login-text">Já possui uma conta? <a href="${pageContext.request.contextPath}/paginasCrud/admin/logar.jsp">Clique aqui</a></p>
            </form>
        </div>
    </div>
    ...
    <div class="container-direito">
        <div class="sobreposicao">
            <img src="${pageContext.request.contextPath}/pagina/imgs/abstract%20geometric.png">
        </div>
        <div class="celular">
            <img src="${pageContext.request.contextPath}/pagina/imgs/modelo_frontal.png">
        </div>
    </div>
