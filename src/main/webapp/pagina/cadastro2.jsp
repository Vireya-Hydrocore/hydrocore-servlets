...
<main>
    ...
    <div class="container-direito">
        <div class="sobreposicao">
            <img src="${pageContext.request.contextPath}/pagina/imgs/abstract geometric.png" alt="Fundo">
        </div>
        <div class="celular">
            <img src="${pageContext.request.contextPath}/pagina/imgs/modelo_frontal.png" alt="Celular">
        </div>
    </div>
