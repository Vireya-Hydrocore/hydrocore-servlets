...
<main>
    ...
    <section class="funcionalidades-section">
        ...
        <div class="container-funcoes">
            <div class="linha-img-dir">
                ...
                <div class="img">
                    <img src="<%= request.getContextPath() %>/pagina/imgs/6853976-uma-cientista.jpg" alt="mulher fazendo calculos com quimicos">
                </div>
            </div>
            <div class="linha-img reverse">
                ...
                <div class="img">
                    <img src="<%= request.getContextPath() %>/pagina/imgs/Sistema-de-gestao-de-estoque-1024x489.jpg.webp" alt="Homen com tablete em um armazem de estoque">
                </div>
            </div>
            <div class="linha-img-dir">
                <div class="infos">
                ...
                <div class="img">
                    <img src="<%= request.getContextPath() %>/pagina/imgs/gestao-de-tarefas-em-telas-diferntes-para-acompanhamento-de-projeto.jpg" alt="pessoa fazendo gestão de atividades">
                </div>
            </div>
            <div class="linha-img reverse">
                <div class="infos">
                ...
                <div class="img">
                    <img src="<%= request.getContextPath() %>/pagina/imgs/analyst-uses-computer-dashboard-data-600nw-2285412737.webp" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid-porques">
                ...
                <div class="block-porque">
                    ...
                    <p>Os registros manuais dão lugar a processos automatizados que reduzem erros, aceleram tarefas
                        e aumentam a segurança da operação. Com tudo centralizado, gestores ganham mais
    ...
    <section id="sobre-nos">
        <img id="img-nos" src="<%= request.getContextPath() %>/pagina/imgs/Imagem do WhatsApp de 2025-09-05 à(s) 16.04.10_f34500b8.jpg" alt="">
        ...
        <div class="container-planos">
            ...
            <div class="grid-planos">
                <div class="card-assinar">
                    ...
                    <p class="preco">R$ 199,00 /mês</p>
                    <ul>
                        <li>Gestão de usuários</li>
                        <li>Escolha e compra</li>
                        <li>Cadastro de funcionários</li>
                        <li>Permissões por tela</li>
                        <li>Parâmetros da água</li>
                        <li>Cálculo de químicos</li>
                        <li>Estoque de químicos</li>
                ...
                <div class="card-assinar-highlit">
                    ...
                    <p class="preco">R$ 599,90 /mês</p>
                    <ul>
                        <li>Tudo do Starter</li>
                        <li>Dashboard com gráficos</li>
                        <li>Dados dinâmicos</li>
                        <li>Tarefas da equipe</li>
                        <li>Calendário de avisos</li>
                        <li>Exportar para Excel</li>
                        <li>Relatórios legais</li>
                ...
                <div class="card-assinar">
                    ...
                    <ul>
                        ...
                        <li>Comparações mensais</li>
                        <li>Relatórios automáticos</li>
                        <li>Alertas inteligentes</li>
                        <li>Integração do estoque</li>
...
<footer>
    <div class="grid-footer">
        <div class="links-grid">
            <img id="img-foot" src="<%= request.getContextPath() %>/pagina/imgs/Group 1.png" alt="">
